        ...
        <div className="container-main max-w-5xl">
          <motion.div className="mb-12 text-center" {...fadeUp}>
            ...
            <p className="mt-4 text-body leading-relaxed">
              Le service de cardiologie est situé à la Clinique Sainte-Clotilde. Vous pouvez joindre
              le secrétariat par téléphone ou par email pour toute demande d’information
              complémentaire.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            >
              ...
              <h3 className="mb-3 text-lg font-semibold">Téléphone</h3>
              <a
