      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="/" className="opacity-70 hover:opacity-100 transition-opacity">Accueil</Link></li>
            <li><Link href="/qui-sommes-nous" className="opacity-70 hover:opacity-100 transition-opacity">Qui sommes-nous ?</Link></li>
            <li><Link href="/medecins-professionnels" className="opacity-70 hover:opacity-100 transition-opacity">Médecins &amp; Professionnels</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="/cardiopathies-ischemiques" className="opacity-70 hover:opacity-100 transition-opacity">Cardiopathies ischémiques</Link></li>
            <li><Link href="/cardiopathies-rythmiques" className="opacity-70 hover:opacity-100 transition-opacity">Cardiopathies rythmiques</Link></li>
            <li><Link href="/cardiopathies-valvulaires" className="opacity-70 hover:opacity-100 transition-opacity">Cardiopathies valvulaires</Link></li>
          </ul>
        </div>
