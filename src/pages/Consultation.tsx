    ...
    <section className="section-padding">
      <div className="container-main max-w-4xl">
        <motion.div {...fadeUp}>
          ...
          <h2 className="text-2xl md:text-3xl mb-4">Consultation</h2>
          <div className="h-1 w-16 rounded-full bg-primary mb-6" />
          <p className="text-body leading-relaxed mb-8">
            Les patients sont reçus en consultation par les médecins du service <strong>cardiologie</strong> au sein de l'établissement. Notre priorité est d'assurer un accueil optimal à tous nos patients, en garantissant expertise, attention et confort.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <motion.div className="medical-card" {...fadeUp}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold">Horaires de consultation</h3>
            </div>
            <ul className="space-y-2">
              {schedule.map((s) => (
                <li key={s.day} className="flex justify-between text-sm text-body">
          ...
          <motion.div className="medical-card" {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.1 }}>
            <h3 className="text-lg font-semibold mb-4">Les documents essentiels</h3>
        ...
        <motion.div className="mt-8 medical-card" {...fadeUp}>
          <h3 className="text-lg font-semibold mb-4">Le secrétariat du service consultation</h3>
          <div className="flex flex-wrap gap-6 text-sm">
            <div>
              <p className="font-semibold text-heading mb-1">Tel:</p>
              <a href={`tel:${contactInfo.phone.replace(/\s/g, "")}`} className="flex items-center gap-2 text-primary font-medium">
                <Phone className="h-4 w-4" /> {contactInfo.phone}
              </a>
            </div>
            <div>
              <p className="font-semibold text-heading mb-1">Fax:</p>
              <p className="text-body">{contactInfo.fax}</p>
            </div>
          </div>
        </motion.div>
