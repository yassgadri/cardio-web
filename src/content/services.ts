...
export const serviceCategories: ServiceCategory[] = [
  {
    ...
    image: withBasePath("/assets/specialite-explorations-non-invasives.jpg"),
    procedures: [
      {
      ...
      },
      {
        ...
        process:
          "L’ETO est un examen du cœur réalisé en passant une petite sonde par la bouche jusqu’à l’œsophage. Cela permet d’obtenir des images très précises du cœur. Avant l’examen, vous devez être à jeun. Une anesthésie locale de la gorge est faite, parfois avec un léger calmant pour votre confort. Il est généralement bien toléré et vous pourrez rentrer chez vous rapidement après.",
      },
      {
  ...
  },
  {
    ...
    image: withBasePath("/assets/specialite-cardiologie-interventionnelle.jpg"),
    procedures: [
      {
        ...
        process:
          "Sous anesthésie locale, un cathéter est introduit par l’artère radiale ou fémorale puis guidé jusqu’aux coronaires. L’examen peut être réalisé en ambulatoire ou en hospitalisation.",
      },
      {
      ...
      },
      {
        ...
        process:
          "Une sonde souple est introduite dans une artère ou une veine afin d’accéder au cœur. Cela permet de mesurer les pressions et d’évaluer la fonction cardiaque et les valvulopathies.",
      },
      {
  ...
  },
  {
    ...
    image: withBasePath("/assets/specialite-rythmologie.jpg"),
    procedures: [
      {
      ...
      {
        title:
          "Mise en place d'un pacemaker (simple et double chambre, stimulation de la branche gauche) ou défibrillateur",
        description:
          "Implantation d’un dispositif de stimulation destiné à corriger certaines anomalies du conduction ou du rythme.",
        process:
...
export const exams: ExamItem[] = [
  {
    ...
    description:
      "Examen simple permettant d’enregistrer l’activité électrique du cœur et d’orienter le diagnostic en cas de symptômes ou de suivi.",
    process:
      "Des électrodes sont placées sur la peau afin d’enregistrer le rythme cardiaque. L’examen est indolore et réalisé sur place.",
  ...
  },
  {
    ...
    description:
      "Examen d’imagerie par ultrasons qui étudie la structure du cœur, son fonctionnement et celui des valves cardiaques.",
    process:
      "Le médecin applique un gel sur la poitrine puis déplace une sonde pour visualiser le cœur en temps réel.",
  ...
  },
  {
    ...
    description:
      "Examen qui analyse la réaction du cœur pendant un effort progressif afin d’évaluer la tolérance à l’exercice et d’orienter le diagnostic.",
    process:
      "L’examen se déroule sur vélo ou tapis avec surveillance continue de l’ECG et de la tension artérielle.",
    preparation:
      "Prévoir une tenue confortable ; les consignes spécifiques sont données lors du rendez-vous.",
    duration: "15 à 30 minutes",
  },
  {
    slug: "holter-ecg",
    ...
    description:
      "Surveillance prolongée du rythme cardiaque afin de détecter certaines anomalies qui n’apparaissent pas toujours lors d’un ECG standard.",
    process:
      "Un petit appareil portable relié à des électrodes enregistre l’activité cardiaque pendant la vie quotidienne.",
    preparation:
      "Venir avec des vêtements pratiques ; les consignes sont précisées au moment de la pose.",
  ...
  },
  {
    ...
    description:
      "Examen utile pour mesurer la tension artérielle sur 24 heures et mieux apprécier sa variabilité au cours de la journée et de la nuit.",
    process:
      "Un brassard automatique réalise des mesures régulières pendant les activités habituelles.",
    preparation:
      "Aucune préparation complexe ; il est recommandé de garder une journée aussi habituelle que possible.",
